...
mk_temp_graph () {
    ...
    rrdtool graph /var/lib/fml/www/voltage_$1.png.png -a PNG --title="Voltage: $1" \
                ...
                'DEF:v1=/var/lib/fml/fml.rrd:r240_1:AVERAGE' \
                'DEF:v2=/var/lib/fml/fml.rrd:r240_2:AVERAGE' \
    ...
    rrdtool graph /var/lib/fml/www/current_$1.png.png -a PNG --title="Current: $1" \
                ...
                --start "N-$2" \
                --vertical-label "Amps" \
                'DEF:c1=/var/lib/fml/fml.rrd:r240_3:AVERAGE' \
                'DEF:c2=/var/lib/fml/fml.rrd:r240_3:AVERAGE' \
